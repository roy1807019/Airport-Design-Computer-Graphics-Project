...
public:
    ...
    void drawCube2(Shader& lightingShader, glm::mat4 model = glm::mat4(1.0f), float r = 0.0f, float g = 0.0f, float b = 0.0f)
    {
        lightingShader.use();
    ...
    void setMaterialisticProperty(glm::vec3 amb, glm::vec3 diff, glm::vec3 spec, float shiny=1.0f)
    {
        this->ambient = amb;
        this->diffuse = diff;
        this->specular = spec;
